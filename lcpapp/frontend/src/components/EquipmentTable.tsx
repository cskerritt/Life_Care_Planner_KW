...
const data: Equipment[] = [
  ...
  },
  {
    ...
    type: "Home Care",
    frequency: "One-time purchase",
    replacementSchedule: "Every 10 years",
    annualCost: 500,
  },
  {
    id: "EQ003",
    ...
    type: "Medical",
    frequency: "Monthly rental",
    replacementSchedule: "N/A",
    annualCost: 2400,
  },
]
...
export const columns: ColumnDef<Equipment>[] = [
  ...
  {
    accessorKey: "replacementSchedule",
    header: "Replacement Schedule",
    cell: ({ row }) => <div>{row.getValue("replacementSchedule")}</div>,
  },
  {
